    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-sky-50">
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-600">
        <div className="mx-auto max-w-7xl px-4 py-10 text-white">
          <h1 className="text-3xl md:text-4xl font-bold leading-tight">Kho đề thi PDF theo môn và khối lớp</h1>
          <p className="mt-2 text-indigo-100">Tải nhanh đề chất lượng, phục vụ luyện thi và kiểm tra định kỳ.</p>
        </div>
      </section>
